...
class ZipAdmin(admin.ModelAdmin):
    list_display = ['id', 'house_value', 'house_spec', 'house_address', 'is_view', 'created_at',  'contact_inform']
    list_editable = ['is_view']
    list_filter = ['is_view', 'created_at']
    search_fields = ['id', 'house_value','house_value', 'house_spec', 'house_address', 'contact_inform' ]
